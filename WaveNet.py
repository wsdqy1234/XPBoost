...
class WaveNetModel(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, args):
        ...
        if args.modelName == 'WaveNet':
            self.model = WaveNet(args, self.dimI, self.dimO).to(torch.device('cuda:{}'.format(args.device)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelName', type=str, default='WaveNet')
    ...
    parser.add_argument('--chanRes', type=int, default=100)
    parser.add_argument('--chanSkip', type=int, default=100)
