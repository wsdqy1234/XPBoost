...
class GraphWaveNetModel(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, args):
        ...
        if args.modelName == 'GraphWaveNet':
            self.model = GraphWaveNet(args, self.dimI, self.dimO).to(torch.device('cuda:{}'.format(args.device)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelName', type=str, default='GraphWaveNet')
    parser.add_argument('--dimFC', type=int, default=64, help='number of RNN hidden units')

    parser.add_argument('--window', type=int, default=24 * 7, help='window size')
    parser.add_argument('--layerSize', type=int, default=7)
    parser.add_argument('--stackSize', type=int, default=1)
    parser.add_argument('--chanRes', type=int, default=32)
    parser.add_argument('--chanDil', type=int, default=32)
    parser.add_argument('--chanSkip', type=int, default=32)
    parser.add_argument('--chanEnd', type=int, default=32)
    parser.add_argument('--dimO', type=int, default=2)
    parser.add_argument('--kernelSize', type=int, default=2)

    parser.add_argument('--gcn_bool', type=bool, default=False)
    parser.add_argument('--addaptadj', type=bool, default=True)
    parser.add_argument('--aptonly', type=bool, default=True)
    parser.add_argument('--randomapt', type=bool, default=True)
    parser.add_argument('--adjPath', type=str, default='')
