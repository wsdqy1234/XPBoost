...
class LSTM(nn.Module):
    ...
    def __init__(self, args, featureNum, outputNum):
        ...
        self.hidR = args.hidR
        self.LSTM = nn.LSTM(input_size=self.featureNum, hidden_size=args.hidR, num_layers=args.layerRNN,
    ...
    def forward(self, x):
        ...
        _, r = self.LSTM(r);  # (1, batch, c_out)
        r = torch.squeeze(r[0], 0)  # (batch, c_out)
        r = self.FC0(r)
        r = torch.tanh(r)
        r = self.dropout(r)
        r = self.FC1(r)
